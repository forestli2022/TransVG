...
# # RefCOCO
python -m torch.distributed.launch --master_port=29501 --nproc_per_node=2 --use_env train.py --batch_size 8 --lr_text 0.00001 --aug_crop --aug_scale --aug_translate --backbone ViT-B/16 --dataset unc --prompt_length 0 --output_dir outputs/refcoco_r50_clip_prompt0

python -m torch.distributed.launch --master_port=29501 --nproc_per_node=2 --use_env train.py --batch_size 8 --lr_text 0.00001 --aug_crop --aug_scale --aug_translate --backbone ViT-B/16 --dataset unc --prompt_length 20 --output_dir outputs/refcoco_r50_clip_prompt20

python -m torch.distributed.launch --master_port=29501 --nproc_per_node=2 --use_env train.py --batch_size 8 --lr_text 0.00001 --aug_crop --aug_scale --aug_translate --backbone ViT-B/16 --dataset unc --prompt_length 40 --output_dir outputs/refcoco_r50_clip_prompt40
