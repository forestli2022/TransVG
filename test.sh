...
# # RefCOCO
python -m torch.distributed.launch --nproc_per_node=2 --use_env eval.py --batch_size 32 --num_workers 4 --bert_enc_num 12 --detr_enc_num 6 --backbone ViT-B/32 --dataset unc --max_query_len 20 --eval_set testA --eval_model ./outputs/refcoco_r50/best_checkpoint.pth --output_dir ./outputs/refcoco_r50
